...
public class PersianDate extends Calendar {
    ...
    public int FinalDay;
    public YearMonthDate FinalDate;
    ...
    public PersianDate(TimeZone zone) {
        this(zone, Locale.getDefault());
    }

    public PersianDate(Locale aLocale) {
        this(TimeZone.getDefault(), aLocale);
    }

    public PersianDate(TimeZone zone, Locale aLocale) {
    ...
    public String getJalaliDate(Date gDate, int dom) {
        ...
        gCal.setTime(gDate);
        gCal.set(Calendar.DAY_OF_MONTH, dom);
        ...
        this.FinalDate = jDate;
        this.FinalYear = jDate.year;
        this.FinalMonth = jDate.month + 1;
        this.FinalDay = jDate.date;
    ...
    public PersianDate(int year, int month, int dayOfMonth, int hourOfDay,
                       int minute) {
    ...
    PersianDate(int year, int month, int dayOfMonth, int hourOfDay,
    ...
    public static int weekOfYear(int dayOfYear, int year) {
        switch (dayOfWeek(PersianDate.jalaliToGregorian(new YearMonthDate(
                year, 0, 1)))) {
            case 2:
                dayOfYear++;
                break;
    ...
    public static String displayDayofWeek(String en) {
        String dow = "";
        switch (en) {
    ...
    public static int persianDayOfWeek() {
    ...
    public static int GetTime(String enTime) {

        switch (enTime) {

            case PersianDate.MORNING:
                return R.string.morning;

            case PersianDate.AFTERNOON:
                return R.string.evening;

            case PersianDate.Night:
